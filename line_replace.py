...
new_lines = lines[:98] + new_ui.split('\n') + lines[110:]

with open(path, 'w', encoding='utf-8') as f:
    f.write('\n'.join(new_lines))

print("Replaced lines 98-109")

# states
text = open(path, encoding='utf-8').read()
if '@State private var skin1Enabled' not in text:
...
# syncPatchStates
if 'skin1Enabled = isPatchActive(id' not in text:
...
# setPatchState
if 'case "47C88561-C524-4164-9ADA-D5F578F4FDC3"' not in text:
